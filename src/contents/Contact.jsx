...
const Contact = () => {
  ...
  const email = "kimjs000118@gmail.com";
      ...
      >
        ...
        <div className="contact-links">
          ...
          <div className="email-copy-container">
            <a
              href={`mailto:${email}?subject=프로젝트 협업 문의&body=안녕하세요, 포트폴리오 보고 연락드립니다.`}
            ...
            <div className="copy-button-wrapper">
              <button className="copy-btn" onClick={handleCopy} title="이메일 복사하기">
        ...
        <footer className="footer-copy">
          &copy; 2026 KIM JEONG SEONG. All Rights Reserved.
        </footer>
      </motion.div>
    </section>
  );
